...
st.markdown(
    "<h1 style='text-align:center; color:#1E3A8A;'>🏏 IPL Score Predictor</h1>",
...
with st.expander("Description"):
    st.info("""
This IPL Score Predictor uses Machine Learning to estimate the final score of a team based on:
• Current Runs
• Overs Completed
• Wickets Fallen
...
The model predicts the expected final score range of the innings.
""")
...
st.markdown(
    "<h4 style='text-align:center;color:black;'>Developed by Abhishek Rai</h4>",
    unsafe_allow_html=True
)
